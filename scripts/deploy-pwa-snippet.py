#!/usr/bin/env python3
"""
Deploy the PWA install Code Snippet to moreshet-maran.com.

Creates the snippet if it doesn't exist yet, updates it if it does.
Identifies the existing snippet by name 'Aneh — PWA Install (שאל את הרב)'.
"""
import base64
import os
import sys
...
NAME    = 'Aneh — PWA Install (שאל את הרב)'
FILE    = os.path.join(
